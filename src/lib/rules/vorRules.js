...
export const MATCH_RULES = [
  ...
  // Каркасные НИШИ кондиционеров → гибрид мокрый фасад (откосы ниши) + НВФ кассета (лицевая).
  // Слово "ниша" подразумевает внутренние откосы, которые штукатурятся.
  { keywords: ['каркасн.*ниш.*кондиционер', 'ниш.*кондиционер', 'ниш.*наружн.*блок'],
    templates: ['wet_facade', 'nvf_subsystem', 'nvf_cladding_cassette'],
    secondary: ['scaffolding', 'kmd_nvf'] },

  // Корзины / короба кондиционеров → только НВФ кассета (без мокрого: открытый каркас, откосов нет).
  { keywords: ['корзин.*кондиционер', 'корзин.*наружн.*блок',
               'фасадн.*короб.*кондиционер', 'короб.*наружн.*блок', 'короб.*кондиционер'],
    templates: ['nvf_subsystem', 'nvf_cladding_cassette'],
    secondary: ['scaffolding', 'kmd_nvf'] },
