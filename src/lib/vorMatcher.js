...
export const TEMPLATES = {
  ...
  flashings: {
    ...
    works: [
      { name: 'Изготовление и монтаж оцинкованных элементов (парапеты, отливы, нащельники)', unit: 'м.п.', noteGp: 'Откосы' },
      { name: 'Устройство герметика', unit: 'м.п.', noteGp: 'Откосы' },
    ],
    materials: [
      { name: 'Лист 0,7 оц. с полимерным покрытием (1 м2 = 5,7 кг)', unit: 'м2', kind: 'основн.', j: 0.2, k: 1.2 },
      { name: 'Заклепка вытяжная комбинированная 4,0*8', unit: 'шт', kind: 'вспомогат.', j: 6, k: 1, price: 1.44 },
  ...
  pp_otsechi: {
    ...
    works: [
      { name: 'Изготовление и монтаж оцинкованных элементов (парапеты, отливы, нащельники)', unit: 'м.п.', noteGp: 'П/П отсечки' },
      { name: 'Устройство герметика', unit: 'м.п.', noteGp: 'П/П отсечки' },
    ],
    materials: [
      { name: 'Лист 0,7 оц. с полимерным покрытием (1 м2 = 5,7 кг)', unit: 'м2', kind: 'основн.', j: 0.2, k: 1.2 },
      { name: 'Заклепка вытяжная комбинированная 4,0*8', unit: 'шт', kind: 'вспомогат.', j: 6, k: 1, price: 1.44 },
