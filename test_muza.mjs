...
const inputPath = path.resolve(process.cwd(), 'Муза_Финал.xlsx');
const pricesPath = path.resolve(process.cwd(), 'prices_muza.xlsx');
const outputPath = path.resolve(process.cwd(), 'test_output_muza.xlsx');
